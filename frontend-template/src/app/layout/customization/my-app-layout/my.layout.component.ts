...
import { MyTopBarComponent } from "../topbar/my.topbar.component";

@Component({
  selector: "my-app-layout",
  templateUrl: "./my.layout.component.html",
})
export class MyAppLayoutComponent implements OnDestroy {
  ...
  @ViewChild(MyTopBarComponent) appTopbar!: MyTopBarComponent;
